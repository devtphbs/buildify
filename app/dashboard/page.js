      ...
      <div style={{ flex:1, overflow:'auto', padding:'20px 18px 60px' }}>
        ...
        {loading ? (
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
            <div onClick={createProject} style={{ background:'var(--card)', border:'1.5px dashed var(--border)', borderRadius:16, padding:14, cursor:creating?'wait':'pointer', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:8, minHeight:150, opacity:creating?.6:1, transition:'all .2s' }}
              onMouseEnter={e=>{ if(!creating) e.currentTarget.style.borderColor='#FF3CAC55' }}
